					...
					<div class="col-md-12">
						<div class="section-title">
							...
							<div class="section-nav">
								...
								<li ><a data-toggle="tab" href="">${loai.name}</a></li>
							</c:forEach>
					...
					<div class="col-md-12">
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<c:forEach var="loai" items="${sessionScope.listCategory}">
								<li ><a data-toggle="tab" href="#tab1">${loai.name}</a></li>
							</c:forEach>
							...
							<div class="products-tabs">
								...
								<div id="tab2" class="tab-pane fade in active">
									<div class="products-slick" data-nav="#slick-nav-2">
										...
										<div class="product">
											<div class="product-img">
												<img src="webapp/views/img/product07.png" alt="">
												<div class="product-label">
													<span class="new">NEW</span>
												</div>
											</div>
										...
										<div class="product">
											<div class="product-img">
												<img src="webapp/views/img/product08.png" alt="">
												<div class="product-label">
													<span class="sale">-30%</span>
												</div>
											</div>
										...
										<div class="product">
											<div class="product-img">
												<img src="webapp/views/img/product09.png" alt="">
											</div>
											<div class="product-body">
												<p class="product-category">Category</p>
												<h3 class="product-name"><a href="#">product name goes here</a></h3>
										...
										<div class="product">
											<div class="product-img">
												<img src="webapp/views/img/product01.png" alt="">
											</div>
											<div class="product-body">
												<p class="product-category">Category</p>
												<h3 class="product-name"><a href="#">product name goes here</a></h3>
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-3">
							...
							<div>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="webapp/views/img/product02.png" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="webapp/views/img/product03.png" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-4">
							<div>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="webapp/views/img/product04.png" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="webapp/views/img/product05.png" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="webapp/views/img/product06.png" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
